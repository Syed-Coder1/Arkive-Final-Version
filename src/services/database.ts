...
class DatabaseService {
  ...
  async updateReceipt(receipt: Receipt, receiptData: { amount: number; date: Date; clientName: string; clientCnic: string; natureOfWork: string; paymentMethod: "cash" | "card" | "cheque" | "bank_transfer" | "easypaisa" | "jazzcash"; }): Promise<void> {
    const store = await this.getObjectStore('receipts', 'readwrite');
